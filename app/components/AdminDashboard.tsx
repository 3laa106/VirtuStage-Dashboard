    ...
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <StatCard
          ...
          value={platformAvgScore != null ? `${platformAvgScore}%` : "--"}
          change={
            totalSessions === 0
              ? "Available after session analysis"
              : "Average across analyzed sessions"
          }
          color="#FFB703"
        ...
        <StatCard
          label="Active Today"
          value={activeToday != null ? activeToday.toString() : "--"}
          change={
            activeToday === 0 ? "No active users today" : "Users active today"
          }
          color="#f472b6"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div className={styles.card}>
          <div className="mb-4">
            <h2 className={styles.cardTitle}>Sessions This Week</h2>
        ...
        <div className={styles.card}>
          <div className="mb-4">
            ...
            <p className={styles.cardSubtitle}>
              Monthly average across all users
            </p>
          </div>
