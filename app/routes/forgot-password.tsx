...
export default function ForgotPassword() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0c10] flex items-center justify-center p-6 lg:p-12 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-[500px] bg-gradient-to-b from-[#5c7cff]/10 lg:from-[#5c7cff]/5 to-transparent pointer-events-none" />
      <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] rounded-full bg-[#5c7cff]/10 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-5%] w-[400px] h-[400px] rounded-full bg-[#0bda62]/5 blur-[100px] pointer-events-none" />

      <div className="w-full max-w-md relative z-10">
        <button
          onClick={() => navigate("/")}
          className="flex items-center gap-2 text-[#9aa1bc] hover:text-white transition-colors mb-8 font-bold text-sm"
        >
          <ArrowLeft className="w-4 h-4" />
          Back to Login
        </button>

        <div className="bg-[#12141c]/80 backdrop-blur-xl border border-[#272b3a] rounded-3xl p-8 lg:p-10 shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#5c7cff] to-[#0bda62]" />
          ...
          {isSuccess ? (
            <div className="flex flex-col items-center text-center py-6">
              ...
              <p className="text-[#9aa1bc] mb-8 font-medium">
            ...
            <>
              <div className="text-center mb-10 mt-2">
                ...
                <p className="text-[#9aa1bc] font-medium text-sm">
